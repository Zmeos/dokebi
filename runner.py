...
#
# Copyright (C) 2009-2015 Ben Finney <ben+python@benfinney.id.au>
# Copyright (C) 2007-2008 Robert Niederreiter, Jens Klein
# Copyright (C) 2003 Clark Evans
# Copyright (C) 2002 Noah Spurrier
# Copyright (C) 2001 J?rgen Hermann
#
...
from timetracker import tabulate_log
...
class DaemonRunner:
    ...
    def _status(self):
        pass
        #the following line gives false no matter what
        #print is_pidfile_stale(self.pidfile)
